//
// This program is a message board for the clients playing the Tic Tac Toe game. The program connects with the server
// and allows the user to communicate with the server board and individual players.
//
