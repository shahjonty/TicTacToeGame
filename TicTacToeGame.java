//
// This program is a running implementation of the Tic Tac Toe game. The program supports the functionality of a
// player to play with multiple people at the same time. Moreover, the function supports inter communication between
// players and within the server chat room. The user can connect to the game through the server and exit the game
